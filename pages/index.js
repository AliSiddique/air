...
<section id='news' class="bg-white dark:bg-gray-900">
  ...
  <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      ...
      <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
        ...
        <a target="_blank">
          <div>
            ...
            <Link to="https://www.youtube.com/c/BroCodez">
          <a target="_blank">
          ...
          <Link to='https://www.youtube.com/c/nesoacademy'>
          <a target="_blank">
          <div >
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
   ...
   <section className="bg-white">
    ...
    {/* <img className="h-60 w-60" src="https://img.icons8.com/external-flaticons-lineal-color-flat-icons/64/000000/external-computer-home-appliance-flaticons-lineal-color-flat-icons-6.png"/> */}
        ...
        <img className="h-60 w-70" src="/u.jpeg"/>
    ...
    <section className="bg-white dark:bg-gray-900">
    <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
    <img className="h-60 w-70" src="/code.jpg"/>
        <div className="mt-4 md:mt-0">
            ...
            <a href="#news" className="inline-flex items-center text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-primary-900">
                Get started
                <svg className="ml-2 -mr-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
            </a>
        </div>
...
<footer className="bg-white dark:bg-gray-800 w-full py-8">
    <div className="max-w-screen-xl mx-auto px-4">
        <ul className="max-w-screen-md mx-auto text-lg font-light flex flex-wrap justify-between">
            ...
            <li className="my-2">
              <Link to="https://github.com/AliSiddique">
            ...
            <li className="my-2">
            <Link to="https://www.linkedin.com/in/alihsiddique/">
       ...
       <Link to="https://twitter.com/alhaown">
