...
<nav className="w-full bg-gray-800 shadow">
              ...
              <ul className="items-center justify-center space-y-8 md:flex md:space-x-6 md:space-y-0">
                ...
                <li className="text-white">
                  <Link href="https://twitter.com/alhaown">
                    <a rel='norefferer' target="_blank">Twitter</a>
                  </Link>
                </li>
    ...
    <iframe className="airtable-embed w-50 text-center block m-auto mb-10" src="https://airtable.com/embed/shrWOjQIIqoxikIVa?backgroundColor=cyan&viewControls=on"  onmousewheel="" width="70%" height="533" ></iframe>
...
<footer className="bg-white dark:bg-gray-800 w-full py-8">
    <div className="max-w-screen-xl mx-auto px-4">
       ...
       <Link href="https://twitter.com/alhaown">
            <a rel="noreferrer" href="https://twitter.com/alhaown" className="text-gray-400 hover:text-gray-800 dark:hover:text-white transition-colors duration-200">
            ...
            <Link href="https://github.com/AliSiddique">
            <a rel="noreferrer" href="https://github.com/AliSiddique" className="text-gray-400 hover:text-gray-800 dark:hover:text-white transition-colors duration-200">
            ...
            <Link href="https://www.linkedin.com/in/alihsiddique/">
            <a rel="noreferrer" href="https://www.linkedin.com/in/alihsiddique/" className="text-gray-400 hover:text-gray-800 dark:hover:text-white transition-colors duration-200">
                <svg width="20" height="20" fill="currentColor" className="text-xl hover:text-gray-800 dark:hover:text-white transition-colors duration-200" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
